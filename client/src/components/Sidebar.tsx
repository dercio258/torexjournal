...
import { LayoutDashboard, BookOpen, CreditCard, Settings, LogOut, TrendingUp, BrainCircuit, CalendarDays, Bell, FlaskConical, Link, Users } from 'lucide-react';
...
export const Sidebar = () => {
    ...
    return (
        <aside className="w-64 bg-slate-900/50 border-r border-slate-800 flex flex-col z-20 backdrop-blur-xl h-screen">
