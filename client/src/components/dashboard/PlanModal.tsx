...
import { X, Sparkles, KeyRound, RefreshCw, Smartphone } from 'lucide-react';
import api from '../../api';

interface PlanModalProps {
    type: 'NO_ACTIVE_PLAN' | 'UPGRADE_REQUIRED' | 'RENEWAL_CONFIRMATION';
    onClose?: () => void;
    featureName?: string;
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
            ...
            <div className="bg-[#0b0e14] border border-slate-800 rounded-3xl w-full max-w-md overflow-hidden shadow-2xl relative p-8 text-center animate-in zoom-in-95 duration-300">
                ...
                {type !== 'NO_ACTIVE_PLAN' && !showPinPrompt && (
                    <button 
                        onClick={onClose} 
